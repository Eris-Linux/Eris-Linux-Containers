...
This directory is mostly interesting as an example of how to create a container using the Google Distroless model instead of Alpine distribution used in previous examples.
...
```
$ ./create-container  arm64  ./09-hello-rust-distroless  hello-rust-distroless
```
