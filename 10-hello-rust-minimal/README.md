...
This directory is mostly interesting as an example of how to create a container with a single static executable, and no other commands nor libraries.
...
```
$ ./create-container  arm64  10-hello-rust-minimal/  hello-rust-minimal
```
